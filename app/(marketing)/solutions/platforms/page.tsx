...
export default function Page() {
  return <MarketingPageTemplate eyebrow="Solution: Platforms" title="Platforms trust operations with configurable verification policies" subtitle="Deploy policy-driven claims verification tuned for platforms risk patterns, user journeys, and regional requirements." sections={[
