...
export default function Page() {
  return <MarketingPageTemplate eyebrow="Solution: Fintech" title="Fintech trust operations with configurable verification policies" subtitle="Deploy policy-driven claims verification tuned for fintech risk patterns, user journeys, and regional requirements." sections={[
