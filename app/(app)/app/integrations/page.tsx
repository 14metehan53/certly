...
export default function Page() {
  return <DashboardPage
    title="integrations"
    subtitle="Operational workspace for integrations in the Certly console."
    cards={[
    ...
    tableRows={[
      ["INTEGRATIONS-001", "Primary", "Healthy", "Trust Ops", "2026-03-25 15:00 UTC"],
      ["INTEGRATIONS-002", "Secondary", "Review", "Platform Risk", "2026-03-25 14:48 UTC"],
      ["INTEGRATIONS-003", "Primary", "Healthy", "Security", "2026-03-25 14:31 UTC"],
    ]}
  />;
}
