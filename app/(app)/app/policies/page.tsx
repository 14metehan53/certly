...
export default function Page() {
  return <DashboardPage
    title="policies"
    subtitle="Operational workspace for policies in the Certly console."
    cards={[
    ...
    tableRows={[
      ["POLICIES-001", "Primary", "Healthy", "Trust Ops", "2026-03-25 15:00 UTC"],
      ["POLICIES-002", "Secondary", "Review", "Platform Risk", "2026-03-25 14:48 UTC"],
      ["POLICIES-003", "Primary", "Healthy", "Security", "2026-03-25 14:31 UTC"],
    ]}
  />;
}
