...
export default function Page() {
  return <DashboardPage
    title="billing"
    subtitle="Operational workspace for billing in the Certly console."
    cards={[
    ...
    tableRows={[
      ["BILLING-001", "Primary", "Healthy", "Trust Ops", "2026-03-25 15:00 UTC"],
      ["BILLING-002", "Secondary", "Review", "Platform Risk", "2026-03-25 14:48 UTC"],
      ["BILLING-003", "Primary", "Healthy", "Security", "2026-03-25 14:31 UTC"],
    ]}
  />;
}
