...
export default function Page() {
  return <MarketingPageTemplate eyebrow="Solution: Gaming" title="Gaming trust operations with configurable verification policies" subtitle="Deploy policy-driven claims verification tuned for gaming risk patterns, user journeys, and regional requirements." sections={[
