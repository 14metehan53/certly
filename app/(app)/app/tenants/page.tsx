...
export default function Page() {
  return <DashboardPage
    title="tenants"
    subtitle="Operational workspace for tenants in the Certly console."
    cards={[
    ...
    tableRows={[
      ["TENANTS-001", "Primary", "Healthy", "Trust Ops", "2026-03-25 15:00 UTC"],
      ["TENANTS-002", "Secondary", "Review", "Platform Risk", "2026-03-25 14:48 UTC"],
      ["TENANTS-003", "Primary", "Healthy", "Security", "2026-03-25 14:31 UTC"],
    ]}
  />;
}
