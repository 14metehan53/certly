...
export default function Page() {
  return <DashboardPage
    title="audit logs"
    subtitle="Operational workspace for audit logs in the Certly console."
    cards={[
    ...
    tableRows={[
      ["AUDIT-LOGS-001", "Primary", "Healthy", "Trust Ops", "2026-03-25 15:00 UTC"],
      ["AUDIT-LOGS-002", "Secondary", "Review", "Platform Risk", "2026-03-25 14:48 UTC"],
      ["AUDIT-LOGS-003", "Primary", "Healthy", "Security", "2026-03-25 14:31 UTC"],
    ]}
  />;
}
