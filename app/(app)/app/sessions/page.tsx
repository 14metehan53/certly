...
export default function Page() {
  return <DashboardPage
    title="sessions"
    subtitle="Operational workspace for sessions in the Certly console."
    cards={[
    ...
    tableRows={[
      ["SESSIONS-001", "Primary", "Healthy", "Trust Ops", "2026-03-25 15:00 UTC"],
      ["SESSIONS-002", "Secondary", "Review", "Platform Risk", "2026-03-25 14:48 UTC"],
      ["SESSIONS-003", "Primary", "Healthy", "Security", "2026-03-25 14:31 UTC"],
    ]}
  />;
}
