...
export default function Page() {
  return <MarketingPageTemplate eyebrow="Solution: Marketplaces" title="Marketplaces trust operations with configurable verification policies" subtitle="Deploy policy-driven claims verification tuned for marketplaces risk patterns, user journeys, and regional requirements." sections={[
